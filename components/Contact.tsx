    ...
    <section id="contact" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto section-padding">
        <div className="text-center mb-16 space-y-4">
          <span className="text-primary-600 font-medium tracking-wider uppercase">Get In Touch</span>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <div className="space-y-8">
            <div className="bg-gradient-to-br from-primary-50 to-white rounded-3xl p-8 shadow-xl">
              ...
              <a
                href="#consultation"
                className="mt-6 w-full bg-gradient-to-r from-primary-500 to-primary-600 text-white px-8 py-4 rounded-full font-medium hover:shadow-lg transition-all duration-300 hover:scale-105 flex items-center justify-center"
              >
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-4">
                {faqs.map((faq, index) => (
                  <details key={index} className="group">
                    <summary className="flex justify-between items-center cursor-pointer list-none p-4 rounded-xl hover:bg-neutral-50 transition-colors">
            ...
            <div className="bg-gradient-to-br from-primary-500 to-primary-600 rounded-3xl p-8 text-white">
              <h3 className="text-2xl font-bold mb-4">New Client Welcome Gift</h3>
              <p className="text-primary-100 mb-6">
                Start your journey with our exclusive welcome package
              </p>
              <div className="space-y-3">
                <div className="bg-white/20 backdrop-blur rounded-xl p-3">
                  <p className="font-semibold">✨ Complimentary skin analysis consultation</p>
                </div>
                <div className="bg-white/20 backdrop-blur rounded-xl p-3">
                  <p className="font-semibold">💎 Free luxury aftercare kit with first treatment</p>
                </div>
                <div className="bg-white/20 backdrop-blur rounded-xl p-3">
                  <p className="font-semibold">🎁 Exclusive member benefits programme</p>
                </div>
              </div>
            </div>
          </div>
