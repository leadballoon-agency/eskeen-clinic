  ...
  const treatments: Treatment[] = [
    {
      ...
      description: 'Natural hair restoration using your own platelets to stimulate growth. Includes FREE biotin injections with all treatments.',
      benefits: ['Natural results', 'No surgery', 'Stimulates new growth', 'Strengthens existing hair', 'Free biotin boost'],
      process: ['Blood draw', 'Centrifuge processing', 'Scalp injections', 'Biotin injection'],
    ...
    },
    {
      ...
      description: 'The vampire facial - natural collagen stimulation for glowing skin. All facial treatments include the delicate eye area.',
      benefits: ['Natural glow', 'Improved texture', 'Reduced wrinkles', 'Even skin tone', 'Eye area included'],
